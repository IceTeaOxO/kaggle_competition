...
model = BertForSequenceClassification.from_pretrained("voidful/albert_chinese_base", num_labels=5)
...
result_df.to_csv("inference_result_BERT_chinese_v7_Q3.csv", index=False)

# 儲存訓練後的模型
model_path = "./model/saved_model_BERT_chinese_v7_Q3"  # 指定模型的儲存路徑
