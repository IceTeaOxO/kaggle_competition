...
tokenizer = BertTokenizer.from_pretrained("ckiplab/macbert-base-chinese")
model = BertForSequenceClassification.from_pretrained("ckiplab/macbert-base-chinese", num_labels=5)
