...
# 初始化tokenizer和模型（使用MacBERT）
tokenizer = BertTokenizer.from_pretrained("ckiplab/bert-base-chinese")
model = BertForSequenceClassification.from_pretrained("ckiplab/bert-base-chinese", num_labels=5)
...
result_df.to_csv("inference_result_BERT_chinese_v7_Q2_v3.csv", index=False)

# 儲存訓練後的模型
model_path = "./model/saved_model_BERT_chinese_v7_Q2_v3"  # 指定模型的儲存路徑
